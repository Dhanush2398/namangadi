    ...
    (o = t.extend(i, o)),
      ...
      (o.getImgSrc = function () {
        return (
          null === o.imgTag &&
            ((o.imgTag = t("<img />")
              .addClass(o["class"].img)
              .attr("src", this.getSrc())),
            "undefined" != typeof o.img.attr("alt") &&
              o.imgTag.attr("alt", o.img.attr("alt"))),
          o.imgTag
        );
      }),
      ...
      (o.setPosition = function (t) {
        "undefined" != typeof t.originalEvent && (t = t.originalEvent),
          ...
          (o.loaded = 1),
          (o.position.x = o.restrict(
            (t.pageX - o.position.img.offset.left) / o.position.img.width
          )),
          (o.position.y = o.restrict(
            (t.pageY - o.position.img.offset.top) / o.position.img.height
          )),
          (o.position.zoom.offset = {
            left: (o.position.zoom.width - o.position.img.width) * o.position.x,
            top:
              (o.position.zoom.height - o.position.img.height) * o.position.y,
          }),
          o
            .getZoomInstance()
            .css({
              transform:
                "translate(-" +
                o.position.zoom.offset.left +
                "px, -" +
                o.position.zoom.offset.top +
                "px)",
            });
      }),
      (o.show = function (t) {
      ...
      (o.init = function () {
        o.img
          .wrap(o.getContainer())
          .after('<div class="' + o["class"].ghost + '"></div>'),
